...
include_once(__DIR__ . '/../../controllers/admin_dashboardController.php');
...
<div class="sidebar">
  ...
  <ul>
    <li><a href="dashboard.php" class="active"><i class='bx bxs-dashboard'></i><span class="links_name">Dashboard</span></a></li>
