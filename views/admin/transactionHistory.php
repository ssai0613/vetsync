<?php
include_once(__DIR__ . '/../../controllers/admin_transactionHistoryController.php');
?>
...
<head>
  ...
  <link rel="stylesheet" href="css/transactionHistory.css?v=<?= time(); ?>">
...
<div class="sidebar">
  ...
  <ul>
    ...
    <li><a href="transactionHistory.php" class="active"><i class='bx bxs-report'></i><span class="links_name">Transaction History</span></a></li>
    <br><br><br>
