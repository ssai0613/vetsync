...
class Appointment
{
    ...
    private function generateUniqueAppointmentId($appointmentDate) {
        // Let's make a super unique ID. So random, diba?
    ...
    // Automatically i-cancel ang mga 'Pending' appointments na past due na. Para clean.
    ...
    {
        // 1. Check sa if naay existing active appointment. Bawal double book, teh.
        ...
        // 2. If free ang slot, gow na, i-add ang appointment.
